# 🛡️ PROJECT: ULTRA MASTER TERMINAL v148 (Render + Voice Chat - FIXED)
# 🛠️ DEVELOPER: KARAN BHAIYA (@KARANBHAIYAAA)

import os, asyncio, logging, glob, sys, time, datetime, re
from datetime import timezone

# ---------- EVENT LOOP FIX (prevents RuntimeError) ----------
...
async def start_engine():
    print("🔥 Starting Karan Bhaiya Bot on Render (Docker - fixed loop)...", flush=True)
